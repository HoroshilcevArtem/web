document.addEventListener('DOMContentLoaded', () => {
    ...
    const slotListContainer = document.querySelector('.slot-list .slot-items');
    ...
    const showSlotList = () => {
        ...
        for (let i = 1; i <= 7; i++) {
            ...
            slotButton.innerHTML = `<img src="assets/Kazino/bot/${i}.png" alt="Слот ${i}" style="width: 150px; height: 150px;">`;
